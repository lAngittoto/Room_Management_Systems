        ...
        <form method="POST" action="index.php?page=bookroom" class="flex flex-col gap-10">
            ...
            <div class="flex flex-col text-2xl">
                ...
                <div>
                    ...
                    <input type="text" name="date" readonly disabled 
                           placeholder="Ex.05-06-2025" 
                           class="outline-none bg-[#f8f8f8] py-2 px-2 border border-[#dcdcdc]">
                </div>
            </div>
                ...
                <div class="flex flex-col">
                    ...
                    <div>
                        ...
                        <input type="text" name="in" readonly disabled 
                               placeholder="9:30" 
                               class="outline-none bg-[#f8f8f8] py-2 px-2 w-[250px] border border-[#dcdcdc]">
                    </div>
                </div>
                <div class="flex flex-col">
            ...
            <button type="submit" 
                class="bg-[#800000] text-2xl py-3 mt-10 text-[#ffffff] text-center rounded-2xl cursor-pointer">
                Confirm Booking
            </button>
        </form>
    </div>
