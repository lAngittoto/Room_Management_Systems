...
class Rooms
{
    ...
    public function __construct($id, $img, $RoomType, $status, $description, $RoomNumber, $people)
    {
        $this->id = $id;
        $this->img = $img;
    ...
    {
        // 🔥 FIXED: tinanggal ang w-[30%], nilagyan ng h-full para pantay height
        ...
        echo '<div class="flex flex-row justify-between p-3 mt-auto">'; // 🔥 mt-auto para laging nasa baba
